...
BEGIN
    ...
    BEGIN TRY
        ...
        ---------------------------------------------------
        INSERT INTO silver.Company2000000006 (
            [Id-8000],
            [Name-1],
        ...
        SELECT
            ...
            s.[timestamp-0],
            CURRENT_TIMESTAMP
        FROM [test_lh].[dbo].[Company2000000006] s
        LEFT JOIN silver.Company2000000006 t
        ...
        FROM silver.Company2000000006 t
        JOIN [test_lh].[dbo].[Company2000000006] s
        ...
        ---------------------------------------------------
        DELETE FROM silver.Company2000000006
        WHERE [systemId-2000000000] NOT IN (
            SELECT [systemId-2000000000] FROM [test_lh].[dbo].[Company2000000006]
        );       
