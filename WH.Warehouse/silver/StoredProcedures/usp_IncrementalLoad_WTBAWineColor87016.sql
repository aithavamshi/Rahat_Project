--Exec silver.usp_IncrementalLoad_WTBAWineColor87016
--select * from [dwh].[silver].[WTBAWineColor87016]
--Truncate table [dwh].[silver].[WTBAWineColor87016]

CREATE     PROCEDURE silver.usp_IncrementalLoad_WTBAWineColor87016
...
BEGIN
    ...
    BEGIN TRY
        ...
        ---------------------------------------------------
        INSERT INTO [WH].[silver].[WTBAWineColor87016] (
            [Description-10],
            [Code-1],
            [timestamp-0],
            [systemId-2000000000],
        ...
        SELECT
            ...
            CURRENT_TIMESTAMP
        FROM [test_lh].[dbo].[WTBAWineColor87016] s
        LEFT JOIN [WH].[silver].[WTBAWineColor87016] t
        ...
        FROM [WH].[silver].[WTBAWineColor87016] t
        INNER JOIN [test_lh].[dbo].[WTBAWineColor87016] s
        ...
        ---------------------------------------------------
        DELETE FROM [WH].[silver].[WTBAWineColor87016]
        WHERE [systemId-2000000000] NOT IN (
            SELECT [systemId-2000000000]
            FROM [test_lh].[dbo].[WTBAWineColor87016]
