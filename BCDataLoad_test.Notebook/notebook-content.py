...
# MAGIC Lakehouse = 'test'; #can also be a GUID
...
""")
start_time = datetime.now()
inserted = merge_result["numTargetRowsInserted"]
updated  = merge_result["numTargetRowsUpdated"]
deleted  = merge_result["numTargetRowsDeleted"]
end_time = datetime.now()
