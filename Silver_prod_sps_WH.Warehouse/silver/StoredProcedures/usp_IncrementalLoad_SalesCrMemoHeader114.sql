...
BEGIN
    ...
    BEGIN TRY
        ...
        FROM [Bronze_2].[dbo].[SalesCrMemoHeader114] s
        ...
        FROM [dwh].[silver].[SalesCrMemoHeader114] t
        JOIN [Bronze_2].[dbo].[SalesCrMemoHeader114] s
        ...
        ---------------------------------------------------
            ...
            DELETE t FROM silver.SalesCrMemoHeader114 t
        WHERE NOT EXISTS
        (
            SELECT 1
            FROM [Bronze_2].[dbo].[SalesCrMemoHeader114] s
