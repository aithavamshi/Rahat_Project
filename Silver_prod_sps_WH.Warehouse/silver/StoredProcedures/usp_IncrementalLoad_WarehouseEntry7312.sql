...
BEGIN
    ...
    BEGIN TRY
        ...
        ---------------------------------------------------
        INSERT INTO [dwh].[silver].[WarehouseEntry7312] (
            [JournalBatchName-2],
        ...
        SELECT
            ...
            CURRENT_TIMESTAMP
        FROM [Bronze_2].[dbo].[WarehouseEntry7312] s
        LEFT JOIN [dwh].[silver].[WarehouseEntry7312] t
        ...
        FROM [dwh].[silver].[WarehouseEntry7312] t
        JOIN [Bronze_2].[dbo].[WarehouseEntry7312] s
