...
BEGIN
    ...
    BEGIN TRY
        ...
        SELECT
            ...
            CURRENT_TIMESTAMP
        FROM [Bronze_2].[dbo].[SalesLine37] s
        LEFT JOIN [dwh].[silver].[SalesLine37] t
        ...
        SET
            ...
            --SELECT *
        FROM [dwh].[silver].[SalesLine37] t
        INNER JOIN [Bronze_2].[dbo].[SalesLine37] s
        ...
        DELETE t FROM [dwh].[silver].[SalesLine37] t
        WHERE NOT EXISTS
        (
            SELECT 1
            FROM [Bronze_2].[dbo].[SalesLine37] s
