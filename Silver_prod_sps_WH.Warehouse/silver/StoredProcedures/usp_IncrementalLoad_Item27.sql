...
BEGIN
    ...
    BEGIN TRY
        ...
        FROM [Bronze_2].[dbo].[Item27] s
        LEFT JOIN [dwh].[silver].[Item27] t
        ...
        FROM [dwh].[silver].[Item27] t
        JOIN [Bronze_2].[dbo].[Item27] s
        ...
        ---------------------------------------------------
		DELETE t FROM [dwh].[silver].[Item27] t
        WHERE NOT EXISTS
        (
            SELECT 1
            FROM [Bronze_2].[dbo].[Item27] s
