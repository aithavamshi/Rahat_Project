...
BEGIN
    ...
    BEGIN TRY
        ...
        ---------------------------------------------------
        INSERT INTO [dwh].[silver].[WTIAAllocSalesLineEntry90107] (
            [SourceNo-290],
            [AllocationCode-10],
        ...
        SELECT
            ...
            CURRENT_TIMESTAMP
        FROM [Bronze_2].[dbo].[WTIAAllocSalesLineEntry90107] s
        LEFT JOIN [dwh].[silver].[WTIAAllocSalesLineEntry90107] t
        ...
        FROM [dwh].[silver].[WTIAAllocSalesLineEntry90107] t
        JOIN [Bronze_2].[dbo].[WTIAAllocSalesLineEntry90107] s
        ...
        --------------------------------------------------- 
        DELETE t FROM [dwh].[silver].[WTIAAllocSalesLineEntry90107] t
        WHERE NOT EXISTS
        (
            SELECT 1
            FROM [Bronze_2].[dbo].[WTIAAllocSalesLineEntry90107] s
