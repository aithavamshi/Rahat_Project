...
BEGIN
    ...
    BEGIN TRY
        ...
        ---------------------------------------------------
        INSERT INTO [dwh].[silver].[SalesHeader36] (
        ...
        SELECT
            ...
            s.[$Company],
            CURRENT_TIMESTAMP
        FROM [Bronze_2].[dbo].[SalesHeader36] s
        LEFT JOIN [dwh].[silver].[SalesHeader36] t
        ...
        FROM [dwh].[silver].[SalesHeader36] t
        JOIN [Bronze_2].[dbo].[SalesHeader36] s
        ...
        ---------------------------------------------------
        DELETE t FROM [dwh].[silver].[SalesHeader36] t
        WHERE NOT EXISTS
        (
            SELECT 1
            FROM [Bronze_2].[dbo].[SalesHeader36] s
