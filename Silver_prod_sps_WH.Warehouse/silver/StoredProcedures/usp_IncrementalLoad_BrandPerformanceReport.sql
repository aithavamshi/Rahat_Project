...
BEGIN
    ...
    BEGIN TRY
        ...
        ---------------------------------------------------
        Insert INTO dwh.silver.BrandPerformanceReport (
                [BudgetName-2],
    			[GLAccountNo-3],
    			[Date-4],
            ...
            SELECT
                ...
                CURRENT_TIMESTAMP,
                NULL
            FROM [Bronze_2].[dbo].[GLBudgetEntry96] s
            LEFT JOIN dwh.silver.BrandPerformanceReport t
        ...
        FROM dwh.silver.BrandPerformanceReport t
        INNER JOIN [Bronze_2].[dbo].[GLBudgetEntry96] s
        ...
        DELETE t FROM dwh.silver.BrandPerformanceReport t
        WHERE NOT EXISTS
        (
            SELECT 1
            FROM [Bronze_2].[dbo].[GLBudgetEntry96] s
