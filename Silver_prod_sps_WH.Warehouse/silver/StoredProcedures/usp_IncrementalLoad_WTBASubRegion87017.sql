...
BEGIN
    ...
    BEGIN TRY
        ...
        ---------------------------------------------------
        INSERT INTO [dwh].[silver].[WTBASubRegion87017] (
            [Description-10],
            [Code-1],
            [timestamp-0],
            [systemId-2000000000],
        ...
        SELECT
            ...
            CURRENT_TIMESTAMP
        FROM [Bronze_2].[dbo].[WTBASubRegion87017] s
        LEFT JOIN [dwh].[silver].[WTBASubRegion87017] t
        ...
        FROM [dwh].[silver].[WTBASubRegion87017] t
        INNER JOIN [Bronze_2].[dbo].[WTBASubRegion87017] s
        ...
        ---------------------------------------------------
        DELETE t FROM [dwh].[silver].[WTBASubRegion87017] t
        WHERE NOT EXISTS
        (
            SELECT 1
            FROM [Bronze_2].[dbo].[WTBASubRegion87017] s
