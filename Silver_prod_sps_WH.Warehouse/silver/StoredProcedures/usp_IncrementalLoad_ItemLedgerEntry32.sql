...
---  select * from [dwh].[silver].[ItemLedgerEntry32]
---  TRUNCATE TABLE [dwh].[silver].[ItemLedgerEntry32]
...
BEGIN
    ...
    BEGIN TRY
        ...
        FROM [Bronze_2].[dbo].[ItemLedgerEntry32] s
        ...
        JOIN [Bronze_2].[dbo].[ItemLedgerEntry32] s
