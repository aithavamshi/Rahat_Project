...
BEGIN
    ...
    BEGIN TRY
        ...
        ---------------------------------------------------
        INSERT INTO [dwh].[silver].[WTBAWineColor87016] (
            [Description-10],
            [Code-1],
            [timestamp-0],
            [systemId-2000000000],
        ...
        SELECT
            ...
            CURRENT_TIMESTAMP
        FROM [Bronze_2].[dbo].[WTBAWineColor87016] s
        LEFT JOIN [dwh].[silver].[WTBAWineColor87016] t
        ...
        FROM [dwh].[silver].[WTBAWineColor87016] t
        INNER JOIN [Bronze_2].[dbo].[WTBAWineColor87016] s
        ...
        ---------------------------------------------------  
        DELETE t FROM [dwh].[silver].[WTBAWineColor87016] t
        WHERE NOT EXISTS
        (
            SELECT 1
            FROM [Bronze_2].[dbo].[WTBAWineColor87016] s
