...
BEGIN
    ...
    BEGIN TRY
        ...
        SELECT
            ...
            CURRENT_TIMESTAMP
        FROM [Bronze_2].[dbo].[TeamSalesperson5084] s
        LEFT JOIN [dwh].[silver].[TeamSalesperson5084] t
        ...
        FROM [dwh].[silver].[TeamSalesperson5084] t
        INNER JOIN [Bronze_2].[dbo].[TeamSalesperson5084] s
        ...
        ---------------------------------------------------
        DELETE t FROM [dwh].[silver].[TeamSalesperson5084] t
        WHERE NOT EXISTS
        (
            SELECT 1
            FROM [Bronze_2].[dbo].[TeamSalesperson5084] s
