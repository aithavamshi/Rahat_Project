...
---  Select * from [dwh].[silver].[PriceListLine7001]
---  TRUNCATE TABLE [dwh].[silver].[PriceListLine7001]
...
BEGIN
    ...
    BEGIN TRY
        ...
        FROM [Bronze_2].[dbo].[PriceListLine7001] s
        ...
        --t.[systemId-2000000000]      = s.[systemId-2000000000],  -- optional if this is your PK
        ...
        INNER JOIN [Bronze_2].[dbo].[PriceListLine7001] s
            ON s.[systemId-2000000000] = t.[systemId-2000000000]
        WHERE 
