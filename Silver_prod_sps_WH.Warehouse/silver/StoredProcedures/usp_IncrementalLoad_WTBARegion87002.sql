...
CREATE               PROCEDURE silver.usp_IncrementalLoad_WTBARegion87002
...
BEGIN
    ...
    BEGIN TRY
        ...
        SELECT
            ...
            CURRENT_TIMESTAMP,
            NULL
        FROM [Bronze_2].[dbo].[WTBARegion87002] s
        ...
        JOIN [Bronze_2].[dbo].[WTBARegion87002] s
        ...
        DELETE t FROM silver.WTBARegion87002 t
        WHERE NOT EXISTS
        (
            SELECT 1
            FROM [Bronze_2].[dbo].[WTBARegion87002] s
