...
BEGIN
    ...
    BEGIN TRY
        ...
        ---------------------------------------------------
        INSERT INTO [dwh].[silver].[WTIAAllocationLedgerEntry90103] (
            [ExpirationDate-110],
            [SourceNo-290],
            [Description-120],
            [SalesOrderNo-130],
        ...
        SELECT
            ...
            CURRENT_TIMESTAMP
        FROM [Bronze_2].[dbo].[WTIAAllocationLedgerEntry90103] s
        LEFT JOIN [dwh].[silver].[WTIAAllocationLedgerEntry90103] t
        ...
        FROM [dwh].[silver].[WTIAAllocationLedgerEntry90103] t
        JOIN [Bronze_2].[dbo].[WTIAAllocationLedgerEntry90103] s
        ...
        DELETE t FROM [dwh].[silver].[WTIAAllocationLedgerEntry90103] t
        WHERE NOT EXISTS
        (
            SELECT 1
            FROM [Bronze_2].[dbo].[WTIAAllocationLedgerEntry90103] s
