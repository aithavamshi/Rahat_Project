...
--select * from [dwh].[silver].[BinContent7302]
--Truncate table [dwh].[silver].[BinContent7302]
...
BEGIN
    ...
    BEGIN TRY
        ...
        SELECT
            ...
            CURRENT_TIMESTAMP
        FROM [Bronze_2].[dbo].[BinContent7302] s
        LEFT JOIN [dwh].[silver].[BinContent7302] t
        ...
        FROM [dwh].[silver].[BinContent7302] t
        JOIN [Bronze_2].[dbo].[BinContent7302] s
        ...
        DELETE t FROM [dwh].[silver].[BinContent7302] t
        WHERE NOT EXISTS
        (
            SELECT 1
            FROM [Bronze_2].[dbo].[BinContent7302] s
