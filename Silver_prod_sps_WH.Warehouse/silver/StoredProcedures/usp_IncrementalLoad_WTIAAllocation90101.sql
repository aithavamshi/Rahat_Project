...
BEGIN
    ...
    BEGIN TRY
        ...
        ---------------------------------------------------
        INSERT INTO [dwh].[silver].[WTIAAllocation90101] (
            [Code-1],
            [Description-10],
            [Source-20],
            [BasedOnType-30],
        ...
        SELECT
            ...
            s.[Blocked-60],
            CURRENT_TIMESTAMP
        FROM [Bronze_2].[dbo].[WTIAAllocation90101] s
        LEFT JOIN [dwh].[silver].[WTIAAllocation90101] t
        ...
        FROM [dwh].[silver].[WTIAAllocation90101] t
        JOIN [Bronze_2].[dbo].[WTIAAllocation90101] s
        ...
        ---------------------------------------------------
        DELETE t FROM [dwh].[silver].[WTIAAllocation90101] t
        WHERE NOT EXISTS
        (
            SELECT 1
            FROM [Bronze_2].[dbo].[WTIAAllocation90101] s
