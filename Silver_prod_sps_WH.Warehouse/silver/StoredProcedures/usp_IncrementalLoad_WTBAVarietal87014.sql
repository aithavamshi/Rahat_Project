...
BEGIN
    ...
    BEGIN TRY
        ...
        ---------------------------------------------------
        INSERT INTO [dwh].[silver].[WTBAVarietal87014] (
            [Description-10],
            [Code-1],
            [timestamp-0],
            [systemId-2000000000],
        ...
        SELECT
            ...
            CURRENT_TIMESTAMP
        FROM [Bronze_2].[dbo].[WTBAVarietal87014] s
        LEFT JOIN [dwh].[silver].[WTBAVarietal87014] t
        ...
        FROM [dwh].[silver].[WTBAVarietal87014] t
        JOIN [Bronze_2].[dbo].[WTBAVarietal87014] s
        ...
        --------------------------------------------------- 
        DELETE t FROM [dwh].[silver].[WTBAVarietal87014] t
        WHERE NOT EXISTS
        (
            SELECT 1
            FROM [Bronze_2].[dbo].[WTBAVarietal87014] s
