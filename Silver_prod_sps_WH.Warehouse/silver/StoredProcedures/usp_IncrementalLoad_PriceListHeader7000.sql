--Exec silver.usp_IncrementalLoad_PriceListHeader7000
...
BEGIN
    ...
    BEGIN TRY
        ...
        ---------------------------------------------------
        INSERT INTO [dwh].[silver].[PriceListHeader7000] (
            [NoSeries-17],
            [Description-2],
            [Code-1],
            [SourceGroup-3],
        ...
        SELECT
            ...
            CURRENT_TIMESTAMP
        FROM [Bronze_2].[dbo].[PriceListHeader7000] s
        LEFT JOIN [dwh].[silver].[PriceListHeader7000] t
        ...
        FROM [dwh].[silver].[PriceListHeader7000] t
        JOIN [Bronze_2].[dbo].[PriceListHeader7000] s
        ...
        ---------------------------------------------------
         DELETE t FROM [dwh].[silver].[PriceListHeader7000] t
        WHERE NOT EXISTS
        (
            SELECT 1
            FROM [Bronze_2].[dbo].[PriceListHeader7000] s
